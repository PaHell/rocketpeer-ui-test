import GUN, { type GunSchema, type IGunInstance, type IGunInstanceRoot, type IGunUserInstance } from 'gun';
import 'gun/sea';
//import 'gun/axe';
...
export default class Weapons {
	...
	user: IGunUserInstance<any, any, Record<string, GunSchema>, IGunInstanceRoot<Record<string, GunSchema>, IGunInstance<Record<string, GunSchema>>>>;
	constructor() {
